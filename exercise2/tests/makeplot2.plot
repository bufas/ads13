...
plot    "rb_insert_bench.txt" using 1:($2/log($1)) title 'RB tree' with lines, \
        "veb_insert_bench.txt" using 1:($2/log(log(15000000))) title 'vEB tree' with lines

set output "bench_predecessor.png"
plot    "rb_pred_bench.txt" using 1:($2/log($1)) title 'RB tree' with lines, \
        "veb_pred_bench.txt" using 1:($2/log(log(15000000))) title 'vEB tree' with lines

set output "bench_delete.png"
plot    "rb_delete_bench.txt" using 1:($2/log($1)) title 'RB tree' with lines, \
        "veb_delete_bench.txt" using 1:($2/log(log(15000000))) title 'vEB tree' with lines
...
set output "bench_predecessor_big.png"
...
plot    "rb_pred_bench.txt" using 1:2 title 'RB tree' with lines, \
